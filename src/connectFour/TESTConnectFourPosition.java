...
public class TESTConnectFourPosition {
	...
	public TESTConnectFourPosition(short pos[][], boolean isRedTurn, PrintWriter recorder) {
		...
		this.outputTest = recorder;
		
	}

	public TESTConnectFourPosition(PrintWriter recorder) {
	...
	public TESTConnectFourPosition playLegalTurn(int column) {
	...
	private TESTConnectFourPosition getPositionAfterInsert(int height, int column) {
		TESTConnectFourPosition next = this.makeHardCopy();
	...
	private TESTConnectFourPosition makeHardCopy() {
		TESTConnectFourPosition hardCopy = new TESTConnectFourPosition(this.pos, this.isRedTurn, this.outputTest);
